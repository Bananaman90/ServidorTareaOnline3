<main style="text-align:center" class="marco">
    ...
    <form action="IndexLogin.php" method="post" enctype="multipart/form-data">
        Usuario: 
        <br><input type="text" name="usuario" value="<?php if(isset($_COOKIE['usuario'])) { echo $_COOKIE['usuario']; } ?>"/><br><br>

        Contraseña:
        <br><input type="password" name="contrasena" value="<?php if(isset($_COOKIE['contrasena'])) { echo $_COOKIE['contrasena']; } ?>"/><br><br>
